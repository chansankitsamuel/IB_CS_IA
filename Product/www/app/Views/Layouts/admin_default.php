...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" href="<?= base_url('/asset/Main_Page/dist/assets/media/logos/favicon.ico') ?>" />
		<!--begin::Fonts-->
							...
							<div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
								...
								<ul class="nav flex-column">
									...
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Users">
										<!--begin::Nav link-->
										<a class="nav-link btn btn-custom btn-icon" href="<?= site_url("/admin/dashboard") ?>">
									...
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Classes">
										<!--begin::Nav link--> 
										<a class="nav-link btn btn-custom btn-icon" href="<?= site_url("/admin/classes") ?>" > 
									...
									<!--end::Nav item-->
									<!--begin::Nav item-->
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Classroom">
										<!--begin::Nav link-->
										<a class="nav-link btn btn-custom btn-icon" href="<?= site_url("/admin/classroom") ?>">
...
-->
		...
		<!--begin::Show confirm delete dialog-->
		<script>
		function confirmDelete(id, object, destination) {
		...
		<!--end::Show confirm delete dialog-->
		<!--end::Javascript-->
	<</body>
	<!--end::Body-->
