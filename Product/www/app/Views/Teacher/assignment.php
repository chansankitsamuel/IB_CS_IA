...
<title>Assignment</title>
                ...
                <div class="container-xxl" id="kt_content_container">
                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="row gy-5 g-xl-11">
                            <!--begin::Mark button-->
                            <div class="d-flex ms-3 flex-right">
                                <button data-bs-toggle="modal" data-bs-target="#markAssignmentModal" class="btn btn-danger ">Mark</button>
                            </div>
                            <!--end::Mark button-->
                            ...
                            <?php foreach ($loadQuestions as $loadQuestion) : ?>
                                <div class="card card-xll-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="flex-right mt-2">
                                        <button data-bs-toggle="modal" data-bs-target="#deleteQuestionModal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="saveQuestionID(<?= $loadQuestion['questionID'] ?>)">
                                    ...
                                    <!--end::Delete Button-->
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            ...
                                            <h3 class="card-title align-items-end flex-column">
                                                <span class="card-label fw-bold fs-6 mb-1">
                                                    ...
                                                    <textarea class="form-control centered-textarea transparent-textarea" id="totalMark_<?= $loadQuestion['questionID'] ?>" name="totalMark" rows="1" cols="2"><?= $loadQuestion['totalMark'] ?></textarea>
                                                    <span class="slash">/</span>
                                                    <textarea class="form-control centered-textarea transparent-textarea" id="maxMark_<?= $loadQuestion['questionID'] ?>" name="maxMark" rows="1" cols="2"><?= $loadQuestion['maxMark'] ?></textarea>
                                                    </div>
                                                </span>
                                            </h3>
                                        </div>
                                        <div class="mb-1 offset--1">
                                            ...
                                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
                                                ...
                                                <!-- Since it is inside another form, ajax is used -->
                                        ...
                                        <div class="card-body py-3">
                                            <!--begin::Form container-->
                                                <!-- <input type="hidden" name="questionID" value="<?= $loadQuestion['questionID'] ?>"> -->
                                                <div class="form-label">
                                                    <label for="question">Question</label>
                                                    <textarea class="form-control" id="question_<?= $loadQuestion['questionID'] ?>" name="question" rows="3"><?= $loadQuestion['question'] ?></textarea><br>

                                                    <label for="answer">Answer</label>
                                                    <textarea disabled class="form-control" id="answer_<?= $loadQuestion['questionID'] ?>" name="answer" rows="3"><?= $loadQuestion['answer'] ?></textarea><br>

                                                    <label for="markingScheme">Marking Scheme</label>
                                                    <textarea class="form-control" id="markingScheme_<?= $loadQuestion['questionID'] ?>" name="markingScheme" rows="3"><?= $loadQuestion['markingScheme'] ?></textarea><br>

                                                    <label for="comment">Teacher's Comment</label>
                                                    <textarea class="form-control" id="comment_<?= $loadQuestion['questionID'] ?>" name="comment" rows="2"><?= $loadQuestion['comment'] ?></textarea><br>
                                                </div>
                            ...
                            <!--begin::Add Question Button-->
                            <div class="d-flex ms-auto flex-center">
                                <button class="btn btn-secondary" id="submitAddQuestionForm" type="button">Add</button >
                            </div>
                        ...
                        <br/><br/><br/><br/><br/>
                        <!--begin::Back button-->
                        <form action="<?= base_url('/teacher/classroom/'.$classID) ?>" method="get">
                    ...
                    <div id="deleteQuestionForm">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="text-center mb-13">
                                <!--begin::Title-->
                                <h1 class="mb-3">Delete Question</h1>
                                <!--end::Title-->
                                <!--begin::Description-->
                                <div class="text-muted fw-bold fs-5">
                                    Delete the question selected
                                </div>
                                <!--end::Description-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button id="submitDeleteQuestionForm" type="button" class="btn btn-lg btn-primary">Delete Question</button>
                                </div>
                                <!--end::Submit Button-->
                            </div>
                            <!--end::Modal body-->
                    ...
                    <div id="markAssignmentForm">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-lg btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
                                    <button id="submitMarkAssigmentForm" type="button" class="btn btn-lg btn-primary">Select</button>
                                </div>
                                <!--end::Submit Button-->
                            </div>
                            <!--end::Modal body-->
    ...
    <script>
        ...
        //     $.ajax({
        //         url: '/teacher/loadQuestion/' + assignmentID,
        //         type: 'GET',
        //         dataType: 'json',
        //         data: {
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submitAddQuestionForm', function(event) {
                event.preventDefault(); // Prevent default form submission

                $.ajax({
                    url: '/teacher/questionAdd', // Provide the full URL if this code is in a separate JavaScript file
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        assignmentID: <?= $assignmentID; ?>,
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submitDeleteQuestionForm', function(event) {
                event.preventDefault(); // Prevent default form submission

                $.ajax({
                    url: '/teacher/questionDelete', // Provide the full URL if this code is in a separate JavaScript file
                    type: 'POST',
                    dataType: 'json',
                    data: {
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submitUpdateQuestionForm', function(event) {
                ...
                $.ajax({
                    url: '/teacher/questionUpdate', // Provide the full URL if this code is in a separate JavaScript file
                    type: 'POST',
                    data: {
                        questionID: window.SavedQuestionID, 
                        assignmentID: <?= $assignmentID; ?>,
                    ...
                    success: function(response) {
                        if (response) {
                            // debug
                            // alert('totalMark: ' + response.totalMark + ' maxMark: ' + response.maxMark);
                            window.location.reload();
                        }
                    },
                    error: function(error) {
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submitAddTagForm', function(event) {
                ...
                $.ajax({
                    url: '/teacher/tagAdd', // Provide the full URL if this code is in a separate JavaScript file
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        questionID: window.SavedQuestionID,
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submitDeleteTagForm', function(event) {
                ...
                $.ajax({
                    url: '/teacher/tagDelete', // Provide the full URL if this code is in a separate JavaScript file
                    type: 'POST',
                    dataType: 'json',
                    data: {
    ...
    <!--begin::Mark Assignment (redirect to student's assignment)-->
    <script>
        // check if the document is ready
        $(document).ready(function() {
            // when the submit button is clicked
            $(document).on('click', '#submitMarkAssigmentForm', function(event) {
                console.log("submitMarkAssigmentForm");
                event.preventDefault(); // Prevent default form submission

                // Get the studentID from the drop-down menu
                var assignmentID = $('#studentAssignmentList').val();

                // Redirect to the student's assignment page
                window.location.href = '/teacher/assignment/' + assignmentID;
            });
        });
    </script>
    <!--end::Mark Assignment (redirect to student's assignment)-->
