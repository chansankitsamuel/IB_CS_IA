                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="<?= base_url('/teacher/assignment/'.$toDoItem['assignmentID']) ?>" class="text-dark fw-bolder text-hover-primary fs-6"><?= $toDoItem['assignmentName'] ?></a>
                                                                <span class="text-muted fw-bold text-muted d-block fs-7"><?= $toDoItem['topic'] ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="<?= base_url('/teacher/classroom/'.$classID) ?>" class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= $classDetails[$classID]['className'] ?></a>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex flex-column w-80 me-2">
                                                            <div class="d-flex flex-stack mb-2">
                                                                <span class="text-muted me-2 fs-7 fw-bold"><?= $toDoItem['overallTeacherProgress'] ?>%</span>
                                                            </div>
                                                            <div class="progress h-6px w-50">
                                                                <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $toDoItem['overallTeacherProgress'] ?>%" aria-valuenow="<?= $toDoItem['overallTeacherProgress'] ?>" aria-valuemin="0" aria-valuemax="100"></div>l
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">Classes current position</span>
                            </h3>
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                        <div class="flex-grow-1 me-2">
                                            <a href="<?= base_url("/teacher/classroom/".$classID) ?>" class="text-gray-800 text-hover-primary fs-6 fw-bolder"><?= $classDetails[$classID]['className'] ?></a>
                                            <span class="text-muted fw-bold d-block fs-7"><?= $classDetails[$classID]['teacherName'] ?></span>
                                        </div>
                                        <span class="badge badge-light fw-bolder my-2">Compare to all classes: <?= $data ?> %</span>
                                    </div>
                                    <!--end::Section-->
                                </div>
                                <!--end::Item-->
